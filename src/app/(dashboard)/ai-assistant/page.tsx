...
export default function AIAssistantPage() {
  ...
  return (
    <div className="flex h-[calc(100vh-10rem)] flex-col md:h-[calc(100vh-6rem)]">
      ...
      <div className="relative flex min-h-0 flex-1 overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm">
        {/* Sidebar (Chat History) */}
        <div
          className={`absolute inset-y-0 left-0 z-20 w-64 transform bg-gray-50 transition-transform duration-200 ease-in-out md:relative md:translate-x-0 ${sidebarOpen ? "translate-x-0 shadow-2xl" : "-translate-x-full md:shadow-none"} `}
        >
          <ChatSidebar
          ...
          <ChatArea
            ...
            onConversationCreated={(id) => {
              ...
              setConversations((prev) => [
                { id, title: "New Chat", createdAt: new Date(), updatedAt: new Date() },
                ...prev,
              ]);
            }}
          />
