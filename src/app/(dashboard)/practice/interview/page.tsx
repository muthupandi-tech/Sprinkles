      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">
            Prepare for placements with realistic, AI-driven interviews.
          </p>
        </div>
      </div>
        ...
        <div className="space-y-6 rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
          ...
          <div>
            ...
            <select
              ...
              className="w-full rounded-xl border border-gray-200 bg-gray-50 p-3 text-sm outline-none focus:border-blue-500 focus:ring-blue-500"
            >
              {COMPANIES.map((c) => (
            ...
            {selectedCompany === "Custom" && (
              <input
                ...
                className="mt-3 w-full rounded-xl border border-gray-200 bg-gray-50 p-3 text-sm outline-none focus:border-blue-500"
              />
            )}
          </div>
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
              {INTERVIEW_TYPES.map((type) => (
                <button
                  ...
                  className={`flex flex-col items-center justify-center gap-2 rounded-xl border p-4 text-center transition-all ${selectedType === type.id ? "border-blue-500 bg-blue-50 text-blue-700" : "border-gray-200 text-gray-600 hover:bg-gray-50"}`}
                >
          ...
          <div>
            ...
            <p className="mb-2 text-xs text-gray-500">
              Paste key sections of your resume (skills, projects) so the AI can ask personalized
              questions.
            </p>
            <textarea
              value={resumeText}
              ...
              rows={5}
              className="w-full resize-none rounded-xl border border-gray-200 bg-gray-50 p-3 text-sm outline-none focus:border-blue-500"
            />
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="rounded-2xl border border-blue-100 bg-gradient-to-br from-blue-50 to-indigo-50 p-8 shadow-sm">
            ...
            <p className="mt-2 text-sm text-blue-800">
              The AI will conduct a 5-question interview based on your selections. Ensure you are in
              a quiet room and your microphone is ready.
            </p>
            <ul className="mt-6 space-y-3">
              <li className="flex items-center gap-2 text-sm font-medium text-blue-900">
                <div className="h-2 w-2 rounded-full bg-blue-500" /> Audio recording enabled
              </li>
              <li className="flex items-center gap-2 text-sm font-medium text-blue-900">
                <div className="h-2 w-2 rounded-full bg-blue-500" /> Real-time feedback generation
              </li>
              <li className="flex items-center gap-2 text-sm font-medium text-blue-900">
                <div className="h-2 w-2 rounded-full bg-blue-500" /> Strict professional persona
              </li>
            </ul>
            <button
              onClick={handleStart}
