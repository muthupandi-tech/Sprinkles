  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center">
        ...
        <Link href="/practice/interview" className="mt-6 text-blue-600 hover:underline">
          Return to Setup
        </Link>
      </div>
    );
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6 pb-12">
      ...
      <div className="space-y-6 rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
        {session.questions
          .filter((q: any) => q.order <= currentQuestion.order)
          .map((q: any) => (
      ...
      <div className="space-y-4 rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
        ...
        <textarea
          ...
          className="min-h-[120px] w-full resize-none rounded-xl border border-gray-200 bg-gray-50 p-4 text-sm outline-none focus:border-blue-500"
